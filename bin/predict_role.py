...
def predict_wrapper(args, reader, exe, test_prog, test_pyreader, graph_vars, epoch,
                    steps):
    """predict_wrapper"""
...
def predict_role_1126(trigger_dict, test_lst):
    """
    trigger predict
    """
    log = trigger_dict['log']
    ...
    if args.do_test:
        log.error("********************** role predict begin **********************")
        test_role_list = predict_wrapper_1126(args, reader, exe, test_prog, test_pyreader,
                                   graph_vars, 1, 'final', test_lst)
        return test_role_list
    else:
        return []


def predict_wrapper_1126(args, reader, exe, test_prog, test_pyreader, graph_vars, epoch,
                    steps, test_lst):
    """predict_wrapper"""
