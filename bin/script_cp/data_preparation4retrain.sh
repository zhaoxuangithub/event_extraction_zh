...
if [[ -e ${data_dir}/train.json ]] ;then
  echo "train.json is exists rm it"
  rm -f ${data_dir}/train.json
else
  echo "train.json is not exists"
fi
...
if [[ -e ${event_type_label_file} ]] ;then
  echo "vocab_trigger_label_map.txt is exists rm it"
  rm -f ${event_type_label_file}
else
  echo "vocab_trigger_label_map.txt is not exists"
fi
if [[ ! -e ${event_type_label_file} ]]; then
...
if [[ -e ${event_role_label_file} ]] ;then
  echo "vocab_roles_label_map.txt is exists rm it"
  rm -f ${event_role_label_file}
else
  echo "vocab_roles_label_map.txt is not exists"
fi
if [[ ! -e ${event_role_label_file} ]]; then
